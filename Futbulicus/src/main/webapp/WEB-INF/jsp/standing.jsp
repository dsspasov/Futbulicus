              ...
              <table class="table table-striped table-hover ">
                ...
                <tbody>
					...
					<c:set var="team_href"
						...
						<tr class="${team.get('position').getAsInt() < 4 ? 'info' : ''} ${team.get('position').getAsInt() > 17 ? 'danger' : ''}">
							<td>${team.get("position").getAsInt()}</td>
							<td><a
								href='/teams/team/${team_href.substring(team_href.lastIndexOf("/") + 1)}'><img src='${team.get("crestURI").getAsString()}' width="14"
